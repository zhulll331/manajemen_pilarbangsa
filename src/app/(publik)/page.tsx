      ...
      <section id="tentang" className="scroll-mt-24 bg-gray-50 rounded-3xl p-8 sm:p-12 md:p-16 border border-gray-100 shadow-sm relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-xl max-w-4xl mx-auto text-left space-y-4 border-l-8 border-l-[#008000]">
              <div className="flex items-center space-x-2 text-[#008000] font-black text-sm uppercase tracking-wider">
                <Sparkles className="w-5 h-5" />
                <span>Lahirnya Platform Pilar Digital Office (Periode 2026/2027)</span>
              </div>
              <p className="text-gray-800 text-base sm:text-lg leading-relaxed font-medium">
                Sebagai wujud komitmen nyata dalam mewujudkan tata kelola organisasi yang berdaya saing global, UKM Pilar Bangsa melakukan lompatan besar pada <span className="font-bold text-[#E31837]">Periode 2026/2027</span> melalui inisiasi dan implementasi platform terpadu <span className="font-bold text-black">Pilar Digital Office</span>. Inovasi teknologi ini merupakan perwujudan langsung dari <span className="font-bold text-black">Misi ke-2 Kepengurusan</span>, yakni mengembangkan tata kelola organisasi yang modern, efektif, efisien, serta transparan bagi seluruh civitas akademika dan masyarakat luas.
              </p>
            </div>
          </div>
          ...
          <div className="pt-4 text-center">
            <a 
              href="/tentang"
              className="inline-flex items-center space-x-2 px-8 py-4 bg-black text-white font-extrabold rounded-2xl hover:bg-gray-800 transition-all shadow-xl text-base"
            >
              <span>Lihat Dokumen Lengkap Visi & Misi Organisasi</span>
            </a>
          </div>
        </div>
      </section>
