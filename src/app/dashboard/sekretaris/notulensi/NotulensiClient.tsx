    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-start sm:items-center gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Notulensi Rapat</h1>
            <p className="text-sm text-gray-500 line-clamp-2 sm:line-clamp-none">Kelola catatan hasil rapat organisasi</p>
          </div>
        </div>
        <button
          onClick={openAdd}
